...
result.panel.size <- unit(2.5, "cm")
result.base.size <- 8
phonetic.panel.width <- unit(3.5, "cm")
phonetic.panel.height <- unit(3, "cm")
duo.panel.width <- unit(5, "cm")
duo.panel.height <- unit(5, "cm")
duo.panel.key <- unit(0.2, 'cm')
phonetic.base.size <- 9
