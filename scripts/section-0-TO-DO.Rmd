# THINGS TO DO LATER:
  ...
  * Xin and Chigusa:
    * I cut some passages. There are linked in this section below. Please check whether they ought to go somewhere else
    * ADD ADDITIONAL REFERENCES?

  * Florian: 
    * **Find a way to signal more clearly that we are also entertaining that combinations of mechanisms matter.**
    * Change decision-bias change model to include surprisal of observation.
