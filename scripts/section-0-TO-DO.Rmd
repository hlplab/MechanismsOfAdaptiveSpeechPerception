...
Let's delete to-dos after they have been addressed, and post in Slack what we've done. Thanks.
  ...
  * Xin and Chigusa:
    ...
    * REMOVE duplicate references from the *bibliography*! Last I checked there were some instances of the same reference being listed twice in the bib. Perhaps those have already been removed, and you just forgot to remove this bullet point?

  * Florian: 
    * Make clear that changes in decision bias can be more than a zero-sum game (cf. case study 2)
    * **Find a way to signal more clearly that we are also entertaining that combinations of mechanisms matter.**
    * Be clear in case studies that we marginalize over noise, lapse rates, and subjects, **simulating what is expected in the limit across subjects, rather than a specific instance of the experiment with a specific number of participants.**
 ...
 * Things to add later:
  * discuss the impact of unbalanced data on different normalization methods
