...
```{r demonstrate-changes-in-representations, fig.width=base.width*2*1.5, fig.height=base.height + 1, fig.cap="(ref:demonstrate-changes-in-representations)", fig.show=if(ANIMATE_FIGURES) 'animate' else 'asis'}
p <- d.exposure %>%
...
if (ANIMATE_FIGURES) {
  ...
  if (SAVE_ANIMATED_VIDEO) {
    anim_save("demonstrate-changes-in-representations.webm", animation = animate(p.animation  +  theme(strip.text.x = element_text(size = 20),
...
```{r demonstrate-changes-in-representations-b, fig.width=base.width*2*1.5, fig.height=base.height + 1, fig.cap="(ref:demonstrate-changes-in-representations-b)", warning=FALSE, message=FALSE, fig.show=if(ANIMATE_FIGURES) 'animate' else 'asis'}
p <- d.exposure %>%
  ggplot(aes(x = !! sym(cue.demo))) +
  # categorization function
  geom_line(
...
if (ANIMATE_FIGURES) {
  ...
  p.animation
  if (SAVE_ANIMATED_VIDEO) {
    anim_save("demonstrate-changes-in-representations-b.webm", animation = animate(p.animation  +  theme(strip.text.x = element_text(size = 20),
                           axis.text.x = element_text(size = 20),
                           axis.title.x = element_text(size = 20),
                           axis.text.y = element_text(size = 20),
                           axis.title.y = element_text(size = 20),
...
if (ANIMATE_FIGURES) {
  ...
  p.animation
  if (SAVE_ANIMATED_VIDEO) {
    anim_save("demonstrate-lapse-bias-change.webm", animation = animate(
      p.animation +  theme(strip.text.x = element_text(size = 20),
                           axis.text.x = element_text(size = 20),
                           axis.title.x = element_text(size = 20),
                           axis.text.y = element_text(size = 20),
                           axis.title.y = element_text(size = 20),
                           ...
                           ), renderer = av_renderer(), width = 1280, height = 720), path = '../figures/knitted/')
  }
} else {
  d.plot <- 
    d.exposure %>%
...
if (ANIMATE_FIGURES) {
  ...
  p.animation
  if (SAVE_ANIMATED_VIDEO) {
    anim_save("demonstrate-lapse-bias-change-nonzero-lapse.webm", animation = animate(p.animation  +  theme(strip.text.x = element_text(size = 20),
                           axis.text.x = element_text(size = 20),
                           axis.title.x = element_text(size = 20),
                           axis.text.y = element_text(size = 20),
                           axis.title.y = element_text(size = 20),
