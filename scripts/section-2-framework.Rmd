...
```{r demonstrate-production-perception-link, fig.width= base.width * 2.5, fig.height = base.height * 1 + .5, fig.cap="(ref:demonstrate-production-perception-link)"}
p <- 
  d.production_to_perception %>%
...
p2 <-   
  ...
  scale_fill_gradient2("Percent /t/-\nresponses", midpoint = 50, low = "blue", high = "red", guide = "colourbar") +
  guides(fill = guide_colorbar(title.position = "left"))

limits <- get_plot_limits(p2)
p2 <- 
  p2 +
  coord_fixed(expand = F, ratio = (limits$xmax - limits$xmin) / (limits$ymax - limits$ymin))
