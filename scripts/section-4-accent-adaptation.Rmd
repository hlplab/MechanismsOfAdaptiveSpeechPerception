...
construct_three_models <- function(
  ...
  representations.pred <- run_model.representations.AA()$visualization
  bias.pred <- run_model.bias.AA()$visualization
  normalization.pred <- run_model.normalization.AA()$visualization
