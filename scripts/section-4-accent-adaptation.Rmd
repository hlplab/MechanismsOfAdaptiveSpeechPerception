...
p.bottom <- d.AA.results.best.cases %>%
  mutate(
...
plot_grid(p.AA.exposure, p.bottom, 
          labels = c('A', 'B)'), 
          ncol = 2, 
         # rel_heights = c(1, 1.2), 
