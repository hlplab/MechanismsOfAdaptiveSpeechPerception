...
p1
ggsave(paste0('../figures/plotly/AA-exposure-test-plot.png'), plot = p1, width = phonetic.panel.width*3 + 1, height = phonetic.panel.height + 1, dpi = 300)
```
...
```{r AA-result-changes-in-normalization, fig.width= result.panel.size * 5 + 1, fig.height= result.panel.size + 1, fig.cap="(ref:AA-result-changes-in-normalization)", warning=FALSE}
