...
```{r AA-exposure-test-plot, fig.width=base.width*3+.5, fig.cap="(ref:AA-exposure-test-plot)", warning=FALSE}
...
make_results_plot_representations(data = d.AA.representations %>% filter(prior_kappa %in% prior_kappa.plot & prior_nu %in% prior_nu.plot), data_best = best_performing_parameters.representations)
```
...
make_results_plot_normalization(d.AA.normalization %>% filter(prior_kappa.normalization %in% prior_kappa.normalization.plot), best_performing_parameters.normalization)
```
...
```{r AA-plot-results-additional-cases, fig.width=base.width*2.5 + .5, fig.height=base.height*2.5 + .5, fig.cap = "(ref:AA-plot-results-additional-cases)", warning=FALSE}
