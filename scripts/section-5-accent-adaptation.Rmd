...
history.optimization_bias1 <- readRDS(get_path(paste0("../models/debugging/bias_models_042223_min=10_max=40_startingat_beta=0.8_lambda=0.5_using_log_accuracy/d.AA.history.optimization.bias_", example_label,".rds")))
```
