...
```{r show-3d-grid-search, fig.show='hold', fig.align='center', out.width= c(rep("49%",4)), fig.cap="(ref:show-3d-grid-search)", fig.subcap=c('Cue reweighting', 'Contrast reduction', 'Contrast shift', 'Contrast collapse')}
filename = c()
for (i in 1:length(cases)){
  example_label = cases[i]
