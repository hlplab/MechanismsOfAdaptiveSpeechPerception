...
# Additional discussion on the sufficiency of each change model {#sec:SI-sufficiency}
This section provides additional discussions on the notion of sufficiency. In particular, we explor how future research can take advantage of the qualitative limitations of the two computationally more parsimonious change models (normalization and changes in decision-making). Given these limitations, it is possible to conduct experiments that can decisively reject the hypotheses that normalization or changes in decision-making are *sufficient* to explain adaptive speech perception. 
